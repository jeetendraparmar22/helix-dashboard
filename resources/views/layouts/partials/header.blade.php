<header class="main-header">
    <div class="d-flex align-items-center logo-box justify-content-start">
        ...
        <a href="{{ route('dashboard') }}" class="logo">
            ...
            <div class="logo-lg">
                <span class="light-logo"><img src="../images/logo-dark-text.png" alt="logo" width="120"
                        height="60" /></span>
                <span class="dark-logo"><img src="../images/logo-light-text.png" alt="logo" width="120"
                        height="60" /></span>
            </div>
        </a>
    </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn" type="submit" id="button-addon3">
                                            <i class="icon-Search"><span class="path1"></span><span
                                                    class="path2"></span></i>
                                        </button>
                                    </div>
                                </div>
                    ...
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            {{-- <a class="dropdown-item" href="extra_profile.html"><i class="ti-user text-muted me-2"></i>
                                Profile</a> --}}
                            <a class="dropdown-item" href="{{ url('/') }}"><i class="ti-lock text-muted me-2"></i>
                                Logout</a>
                        </li>
                    </ul>
                </li>
